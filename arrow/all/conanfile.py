...
class ArrowConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        replace_in_file(self, os.path.join(self.source_folder, "cpp/src/arrow/vendored/double-conversion/utils.h"),
                        "defined(__mips__)", "defined(__mips__) || defined(__loongarch64)")
